...
/**
 * @brief Removes a file and marks its clusters as free.
 *
 * This function removes the specified file, freeing up the clusters it occupied
 * in the FAT table. It also updates the directory entry in the parent directory
 * to reflect the file deletion.
 *
 * @param file   The file to be removed.
 * @param parent The parent directory of the file.
 */
void fat_file_remove(fat_file file, fat_file parent_dir);
...
/*
 * The function "fat_file_hide" hides a FAT file by setting its first character in the base name to
 * 0xe5 and changing its attributes to FILE_ATTRIBUTE_SYSTEM.
 * The "file" parameter is a pointer to a fat_file structure, which represents a file in
 * the FAT file system. It contains information about the file, such as its directory entry and
 * position in its parent directory.
 * @parent The "parent" parameter is the directory where the file is located. 
 */
